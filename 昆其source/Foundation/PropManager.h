...
public:
	...
	std::string Getpassed(void) {return m_passwd;};
	...
	//m_moreVideoadd
	std::string ChosMoreVideo(void)		{return m_moreVideoadd;};//m_strtimeMore
	std::string ChosMoreVideoTime(void)		{return m_strtimeMore;};//m_showsize
	...
	bool GetCoderInfobyServiceID(int seviceid,CoderDev& CoderDevInfo);
...
private:
	...
	std::string m_moreVideoadd;
	std::string m_strtimeMore; 
